...
(function() {
  var DRAGGING_ILLUSION_FROM_LIST, DRAGGING_ILLUSION_FROM_PANEL, DRAGGING_OUTPUT_FROM_PANEL, clearContext, colHeight, createJanish, createPlus, currentDraggingData, currentDraggingType, currentIllusionList, deleteJanish, documentReady, drawJanish, drawLine, drawPadding, illusionDict, illusions, janishPlusHtml, loadIllusions, loadJanish, logLocation, monitorShowed, panel_janish, setInput, setupDropEvent, templateJanishItem, templateJanishSub;
  ...
  setupDropEvent = function() {
    ...
    return $(".janish").on("dblclick", function() {
      var $this, path;
      $this = $(this);
      path = $this.attr("path");
