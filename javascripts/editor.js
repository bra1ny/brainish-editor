...
(function() {
  var DRAGGING_ILLUSION_FROM_LIST, DRAGGING_ILLUSION_FROM_PANEL, DRAGGING_OUTPUT_FROM_PANEL, colHeight, createPlus, currentDraggingData, currentDraggingType, currentIllusionList, documentReady, drawJanish, drawPadding, illusionDict, illusions, janishPlusHtml, loadIllusions, loadJanish, logLocation, panel_janish, setupDropEvent, templateJanishItem, templateJanishSub;
    ...
    if (Array.isArray(janish)) {
      ...
      if (illusion.sub) {
        ...
        for (_k = 0, _len1 = sub_list.length; _k < _len1; _k++) {
          ...
          _results1.push(createPlus(c, "path"));
        }
        return _results1;
      }
    }
